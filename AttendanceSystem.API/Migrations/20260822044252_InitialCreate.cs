        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "text", nullable: false),
                    LatitudeIn = table.Column<decimal>(type: "numeric(10,8)", precision: 10, scale: 8, nullable: true),
                    LongitudeIn = table.Column<decimal>(type: "numeric(11,8)", precision: 11, scale: 8, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("22222222-2222-2222-2222-222222222222"), "Manage employees & attendance", "HR" },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "Self-service attendance", "Employee" }
                });
